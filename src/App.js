  ...
  return(
    ...
    screenOptions={({ route }) => ({
     tabBarIcon: ({ color }) => {
       ...
       return <View style={{borderWidth:0,borderColor:"white",borderRadius:30}}><Feather name={iconName} size={25} color={color} /></View>
     },
 ...
 const App = () => {
   ...
   return (
     ...
     <PaperProvider theme={theme}>
        <StatusBar barStyle="dark-content" backgroundColor="darkorange"/> 
